function HomeSecion(): JSX.Element {
  return (
    <section id="home" className="relative z-10 h-screen w-full">
      <h2 className="relative left-1/2 top-1/4 w-1/2 -translate-x-1/2 animate-tracking-in-expand text-center text-3xl font-medium text-gray-900 [text-wrap:balance] dark:text-gray-50 sm:text-6xl">
        Hi! my name is{' '}
