	...
	return (
		<div className="group/vinyl flex h-full items-center">
			...
			<div className={cn("mx-4 flex flex-col justify-center w-full", loading && "gap-2")}>
				{loading ? (
					<>
						<div className="skeleton h-5 w-full lg:w-5/6 max-w-sm rounded-lg bg-gray-500 dark:bg-gray-200" />
						<div className="skeleton h-4 w-2/3 max-w-sm rounded-lg bg-gray-400 dark:bg-gray-400" />
					</>
				) : (
					<>
